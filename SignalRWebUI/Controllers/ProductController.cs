...
namespace SignalRWebUI.Controllers
{
	public class ProductController : Controller
	{
		...
		public async Task<IActionResult> CreateProduct(CreateProductDto createProductDto)
		{
			...
			var responseMessage = await client.PostAsync("https://localhost:7037/api/Product", stringContent);
			if (responseMessage.IsSuccessStatusCode)
			{
		...
		public async Task<IActionResult> UpdateProduct(int id)
		{
			...
			var responseMessage1 = await client1.GetAsync("https://localhost:7037/api/Category");
			...
			var client = _httpClientFactory.CreateClient();
			var responseMessage = await client.GetAsync($"https://localhost:7037/api/Product/{id}");
			if (responseMessage.IsSuccessStatusCode)
			{
				var jsonData = await responseMessage.Content.ReadAsStringAsync();
		...
		public async Task<IActionResult> UpdateProduct(UpdateProductDto updateCategoryDto)
		{
			...
			StringContent stringContent = new StringContent(jsonData, Encoding.UTF8, "application/json");
			var responseMessage = await client.PutAsync("https://localhost:7037/api/Product/", stringContent);
			if (responseMessage.IsSuccessStatusCode)
			{
				return RedirectToAction("Index");
			}
